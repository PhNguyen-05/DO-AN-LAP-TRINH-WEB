...
////    // 🌸 Register shop
////    @GetMapping("/register")
////    public String registerShop(Model model, HttpSession session) {
////        User currentUser = (User) session.getAttribute("currentUser");
////        if (currentUser == null) {
////            return "redirect:/auth/login";
////        }
////        model.addAttribute("title", "Register Shop");
...
//                product.setImageUrl(fileName); // ✅ SỬA CHỖ NÀY
//            }
//
...
//    public ResponseEntity<String> editProduct(@PathVariable Integer id, @ModelAttribute Product product, HttpSession session) {
//        User currentUser = (User) session.getAttribute("currentUser");
